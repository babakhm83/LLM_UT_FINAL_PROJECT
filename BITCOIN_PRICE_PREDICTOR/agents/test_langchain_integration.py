...
def test_langchain_integration():
    ...
    sample_config = {
        "api_keys": {"gemini": os.getenv("GEMINI_API_KEY", "your-gemini-key-here")},
        "models": {
...
def show_usage_examples():
    ...
    examples = [
        ...
        (
            "Custom Config",
            "python langchain_bitcoin_advisor.py --config my_config.json",
        ),
...
def create_sample_conversation():
    ...
    conversation = [
        ...
        (
            "🤖 Advisor",
            "10-day forecast shows upward trend. Here's my recommendation...",
        ),
        ("👤 User", "What about the technical indicators?"),
        (
            "🤖 Advisor",
            "Let me check the technical analysis from our previous discussion...",
        ),
        (
            "🤖 Advisor",
            "Based on our conversation history, RSI is at 68, MACD shows bullish crossover...",
        ),
    ]
